...
exports.generateChangeDetails = void 0;
...
const formatFieldName = (path, appData) => {
    if (FIELD_NAMES[path]) {
...
const deepDiff = (path, obj1, obj2, changes, appData) => {
    ...
    for (const key of keys) {
        ...
        if (isObject(val1) || isObject(val2)) {
            ...
            if (currentPath === 'amazonContents') {
                ...
                languages_1.LANGUAGES.forEach(lang => {
...
const generateChangeDetails = (entityType, oldEntity, newEntity, appData) => {
    const changes = [];
...
exports.generateChangeDetails = generateChangeDetails;
