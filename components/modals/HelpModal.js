      ...
      <div className="bg-slate-800 rounded-lg shadow-xl w-full max-w-3xl border border-slate-700 max-h-[90vh] flex flex-col" onClick={e => e.stopPropagation()}>
        <div className="p-4 border-b border-slate-700 flex justify-between items-center flex-shrink-0">
          <h3 className="text-lg font-semibold text-slate-200 flex items-center">
            <Icon_1.Icon name="question-circle" className="mr-3 text-cyan-400"/>
        ...
        <div className="p-6 space-y-4 overflow-y-auto">
          <CollapsibleSection_1.CollapsibleSection title="Concepto Básico: Paneles y Mapeo" defaultOpen>
          ...
          <CollapsibleSection_1.CollapsibleSection title="Tipos de Mapeo en las Columnas" defaultOpen>
            <p className="text-sm text-slate-300 mb-2">
              Cada columna en tu lienzo puede tener uno de tres tipos de contenido:
            </p>
            <ul className="list-disc list-inside text-sm space-y-3">
              <li>
                <strong className="text-cyan-300">Mapeado (Mapped):</strong> El valor se toma directamente de un campo del producto. Se identifica por el icono <Icon_1.Icon name="link"/> y el placeholder (ej: <code>{`{product.name}`}</code>). Se crea al arrastrar y soltar desde la paleta de datos.
              </li>
              <li>
                <strong className="text-slate-300">Estático (Static):</strong> El valor es un texto fijo que tú escribes. Será el mismo para todas las filas exportadas (ej: "España"). Puedes escribir directamente en el campo o usar el botón <Icon_1.Icon name="font"/>.
              </li>
              <li>
                <strong className="text-yellow-300">Fórmula (Formula):</strong> El valor es el resultado de una combinación de texto, placeholders y funciones. Se identifica por el icono <Icon_1.Icon name="calculator"/> y se edita con el botón <i>fx</i>.
              </li>
            </ul>
          </CollapsibleSection_1.CollapsibleSection>

          <CollapsibleSection_1.CollapsibleSection title="Editor de Fórmulas y Funciones" defaultOpen>
            <p className="text-sm text-slate-300 mb-2">
