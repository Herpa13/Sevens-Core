...
exports.FilterPillsSelector = void 0;
const react_1 = __importStar(require("react"));
const TextInput_1 = require("./TextInput");
const Icon_1 = require("./Icon");
const FilterPillsSelector = ({ options, selectedIds, onSelectionChange, placeholder = "Buscar..." }) => {
...
exports.FilterPillsSelector = FilterPillsSelector;
