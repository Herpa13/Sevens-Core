...
exports.DeliveryNoteDetailView = void 0;
...
const DeliveryNoteDetailView = ({ initialData, onSave, onDelete, onCancel, appData, setIsDirty, setSaveHandler }) => {
    ...
    return (<div className="bg-slate-800 rounded-lg p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <FormField_1.FormField label="Número de Albarán" htmlFor="deliveryNoteNumber">
          <TextInput_1.TextInput id="deliveryNoteNumber" name="deliveryNoteNumber" value={data.deliveryNoteNumber} onChange={handleInputChange}/>
        </FormField_1.FormField>
        <FormField_1.FormField label="Unidades Recibidas" htmlFor="unitsReceived">
          <TextInput_1.TextInput type="number" id="unitsReceived" name="unitsReceived" value={data.unitsReceived} onChange={handleInputChange}/>
        </FormField_1.FormField>
        <FormField_1.FormField label="Fecha de Recepción" htmlFor="receivedDate">
          <TextInput_1.TextInput type="date" id="receivedDate" name="receivedDate" value={data.receivedDate} onChange={handleInputChange}/>
        </FormField_1.FormField>
        <FormField_1.FormField label="Documento del Albarán" htmlFor="documentUrl" className="md:col-span-2">
...
exports.DeliveryNoteDetailView = DeliveryNoteDetailView;
