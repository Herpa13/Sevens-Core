...
exports.ManufacturingDashboard = void 0;
...
const ManufacturingDashboard = ({ appData, onSelectItem, onAddNew }) => {
    ...
    return (<div className="bg-slate-800 rounded-lg">
      <div className="p-4 sm:p-6 border-b border-slate-700 flex justify-between items-center">
        ...
        <button onClick={() => onAddNew('purchaseOrders')} className="flex items-center px-4 py-2 bg-cyan-500 text-slate-900 font-semibold rounded-md hover:bg-cyan-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-800 focus:ring-cyan-500">
      ...
      <div className="p-4 sm:p-6 space-y-4">
        {sortedOrders.map(order => {
            ...
            return (<CollapsibleSection_1.CollapsibleSection key={order.id} title={<div className="flex justify-between items-center w-full">
...
exports.ManufacturingDashboard = ManufacturingDashboard;
